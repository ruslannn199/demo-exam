...
const ServiceBadge: NextComponentType<NextPageContext, {}, ServiceBadgeProps> = (
    ...
    <Card className="flex flex-col h-full max-h-[360px] hover:translate-y-[-5px] duration-200 cursor-pointer ease-in">
      ...
      <CardFooter className="mt-auto">
        <Button className="group" asChild>
          <Link href={link}>Узнать больше <ArrowRightCircle className="ml-2 rotate-[-45deg] group-hover:rotate-0 duration-200" /></Link>
        </Button>
      </CardFooter>
    </Card>
  );
